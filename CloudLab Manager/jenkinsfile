    ...
    stages {
        ...
        stage(' Cleanup Old Docker Containers') {
            steps {
                ...
                docker container stop cloudlab_backend || true
                docker container stop cloudlab_frontend || true

                echo "Removing old Docker containers..."
                docker container rm cloudlab_backend || true
                docker container rm cloudlab_frontend || true
                '''
            }
        }
